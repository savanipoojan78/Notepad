...
public class editor extends JFrame
{
	...
	JMenu menu = new JMenu("<html><p style='text-align:center;'>Edit</p></html>");
    ...
    JMenuItem fgcolor = new JMenuItem("Foreground");
	...
	JMenu FILE = new JMenu("<html><p style='text-align:center;'>File</p></html>");
	JMenu EDIT = new JMenu("<html><p style='text-align:center;'>Edit</p></html>");
	JMenu FORMAT = new JMenu("<html><p style='text-align:center;'>Format</p></html>");
	JMenu VIEW = new JMenu("<html><p style='text-align:center;'>View</p></html>");
	JMenu HELP = new JMenu("<html><p style='text-align:center;'>Help</p></html>");
	...
	public editor()
	{
		...
		FORMAT.setPreferredSize(new Dimension(60,25));
		VIEW.setPreferredSize(new Dimension(45,25));
		HELP.setPreferredSize(new Dimension(45,25));
		Font f = new Font("sans-serif",Font.PLAIN, 16);
		Font f1 = new Font("sans-serif",Font.PLAIN, 16);
		NEWFILE.setFont(f);
		//NEWFILE.setText(CENTER);
		//FORMAT.setText(CENTER);
		FILE.setFont(f1);
		EDIT.setFont(f1);
		FORMAT.setFont(f1);
		VIEW.setFont(f1);
		...
		PASTEDIT.setFont(f);
		DELETEDIT.setFont(f);
		FINDNEXTEDIT.setFont(f);
		FINDEDIT.setFont(f);
		REPLACEDIT.setFont(f);
		GOTOEDIT.setFont(f);
		SELECTEDIT.setFont(f);
		TIMEDIT.setFont(f);
		
		FORMAT.add(WORDFORMAT);
		WORDFORMAT.setFont(f);
		WORDFORMAT.setSelected(true);
		FORMAT.add(FONT);
		FONT.setFont(f);
		
		VIEW.add(STATUSVIEW);
		STATUSVIEW.setFont(f);
		...
		public void actionPerformed(ActionEvent e)
		{
			Color cl = JColorChooser.showDialog(null,"SELECT Background COLOR",Color.WHITE);
			area.setBackground(cl);
		}
		...
		public void actionPerformed(ActionEvent e)
		{
			Color c2 = JColorChooser.showDialog(null, "Select Foreground color", Color.BLACK);
			area.setForeground(c2);
		}
		...
		ABOUT.addActionListener( new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
	    		...
	    		String message = "This application created by Poojan & Pritesh";
		...
		String line = area.getText();
				...
				else
				{
					...
					if(result == JFileChooser.APPROVE_OPTION) 
					{
					   ...
					   File abc= fc.getSelectedFile();
					   setTitle(abc.getName() + "-Notepad");
