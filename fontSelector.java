...
public class fontSelector extends JDialog
{
	...
	String fontSizeString[] = {"10","12","14","16","18","20","22","24","28","32","36","40","44","48","52","56","60"};
	...
	public fontSelector()
	{
		...
		preview.setBounds(120,130,200,50);
		...
		fontSelector.addActionListener(new ActionListener()
		{
			...
			{
				preview.setFont(new Font(String.valueOf(fontSelector.getSelectedItem()),fontStyle.getSelectedIndex(),Integer.parseInt(String.valueOf(fontSize.getSelectedItem()))));
			}
		});
